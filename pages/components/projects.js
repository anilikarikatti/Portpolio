...
export default function Projects(){
    return(
        ...
        <div className='project-page bg-slate-500' >
            ...
            <div className="flex flex-col sm:ml-0 mt-10">
                <div className=" sm:h-96 sm:w-full h-52 w-72 ml-10 border-solid border-1  mybiobackup bg-contain sm:ml-64 "></div>
                ...
                <div className=" sm:h-96 sm:w-full h-52 w-72 ml-10  border-solid border-1  admin_img bg-contain sm:ml-64  "></div>
                <h2 className="mt-10">memory game </h2>
                <div className=" sm:h-96 sm:w-full h-52 w-72 ml-10  border-solid border-1  memory_game1 bg-contain sm:ml-64 mt-10"></div>
                <div className=" sm:h-96 sm:w-full h-52 w-72 ml-10  border-solid border-1  memory_game2 bg-contain sm:ml-64 mt-10"></div>
                <div className="  border-solid border-1  sm:ml-64 ml-2 sm:mt-10 text-stone-100 capitalize mr-2 mb-10">
