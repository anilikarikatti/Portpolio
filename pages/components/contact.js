  ...
  return (
    <div className='bg-white h-screen h-fit'>
        ...
        <div className='flex justify-center'>
          <div className='sm:h-[350px] h-[250px] border-2 border-blue-400 w-[700px] rounded-lg' >
            <div className='grid grid-cols-6 justify-center'>
              <div className='sm:col-start-3 sm:col-end-4 col-start-2 col-end-3 call sm:h-[120px] h-[60px]'></div>
              <div className='relative sm:top-14 top-6'><a href='tel:7795549800'>7795549800</a> </div>

            </div>
            <div className='grid grid-cols-6 '>
              <div className='sm:col-start-3 sm:col-end-4 col-start-2 col-end-3 email sm:h-[100px]  h-[30px]' ></div>
              <div className='relative sm:top-10'><a href="mailto:anilkarikatti333@gmail.com"> anilkarikatti333@gmail.com</a></div>
            ...
            <div className='grid grid-cols-6 justify-center items-center'>
              ...
              <div className='relative sm:top-2'><a href='https://github.com/anilikarikatti'>https://github.com/anilikarikatti</a></div>
        ...
        <div className="links flex justify-center">
                    ...
                    <div className="h-20 w-20  bg-orange-400 text-center l1 contacts" ><Link href="/components/home"><p className="data" >home</p></Link></div>
