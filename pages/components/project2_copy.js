        ...
        <>
            ...
            <div className="about pg background box " > 
                ...
                <div className="links flex headrs " id="headrs">
                    <div className=" h-20 w-20  bg-green-200 l1 text-center project" data-aos = "fade-right"><Link href="/components/home"><p className="data">home</p></Link></div>
                        ...
                        <div className="h-20 w-20  bg-orange-200 text-center l1 contacts" data-aos = "fade-left"><Link href="/components/contact"><p className="data" >contact</p></Link></div>

                </div>

                {/* <h2 className="uppercase mt-32">mybiobackup </h2> */}

                <div className="grid sm:grid-cols-2 sm:ml-20 sm:mt-40 border-2 sm:mr-20 imgs shad">
          ...
          {/* resume builder added */}
                ...
                <div className="grid grid-cols-2 ml-20 mt-40 border-2 mr-20 imgs shad">
                    ...
                    <div className={"bg-contain img_div memory  hov clipimg  "+ fourth_images[index]}>
                    </div>
